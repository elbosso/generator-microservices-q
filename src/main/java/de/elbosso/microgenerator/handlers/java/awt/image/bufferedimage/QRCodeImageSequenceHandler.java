...
@javax.annotation.Generated(value="de.elbosso.util.processors.GeneratorRestHandlerProcessor", date="2021-01-29T15:07:37.440Z")
@Path("/qrCodeImg")
public class QRCodeImageSequenceHandler
{
    ...
    @GET
    @Produces("image/png")
    public StreamingOutput get(    @DefaultValue("330")
