...
@javax.annotation.Generated(value="de.elbosso.util.processors.GeneratorRestHandlerProcessor", date="2020-12-05T13:57:11.643Z")
@Path("/hausNummer")
public class HausNummerSequenceHandler
{
    ...
    boolean Ranges,
    @DefaultValue("false")
    @QueryParam("RomanNumerals")
    boolean RomanNumerals,
    @DefaultValue("false")
    @QueryParam("Appartments")
    boolean Appartments)
    {
