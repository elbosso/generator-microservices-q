...
@javax.annotation.Generated(value="de.elbosso.util.processors.GeneratorRestHandlerProcessor", date="2021-01-29T15:07:37.449Z")
@Path("/qrCodeSvg")
public class QRCodeSVGSequenceHandler
{
    ...
    public Response get(    @DefaultValue("320")
