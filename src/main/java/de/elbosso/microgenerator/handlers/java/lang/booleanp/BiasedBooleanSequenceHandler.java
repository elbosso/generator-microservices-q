...
@javax.annotation.Generated(value="de.elbosso.util.processors.GeneratorRestHandlerProcessor", date="2020-12-27T11:21:27.142Z")
@Path("/biasedBoolean")
public class BiasedBooleanSequenceHandler
{
    ...
    public Response get(    @DefaultValue("0.9")
    @QueryParam("Threshold")
    double Threshold)
    {
        generator.setThreshold(Threshold);
        return Response.ok(new de.elbosso.microgenerator.bool.BooleanResource(generator.next())).build();
    }
/*
    @GET
    @Produces("image/png")
