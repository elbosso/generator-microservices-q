...
@javax.annotation.Generated(value="de.elbosso.util.processors.GeneratorRestHandlerProcessor", date="2020-12-28T13:17:01.111Z")
@Path("/avatarImg")
public class AvatarIconImageSequenceHandler
{
    ...
    @GET
    @Produces("image/png")
    public StreamingOutput get(    @DefaultValue("48")
